...
export default function Navbar() {
	...
	const navItemClass = ({ isActive }) =>
		`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ease-in-out ${
			isActive 
				? 'text-white bg-gradient-to-r from-primary to-primary/80 shadow-lg shadow-primary/25 dark:shadow-primary/40' 
				: 'text-gray-700 dark:text-gray-200 bg-white/40 dark:bg-neutral-800/40 backdrop-blur-sm hover:bg-white/70 dark:hover:bg-neutral-700/60 hover:shadow-md hover:scale-105'
		}`;
